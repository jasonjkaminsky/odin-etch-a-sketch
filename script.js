...
///// Sets up event listener when new grid or rainbow button clicked ////
newGridButton.addEventListener("click", resetNew);

///// Makes 16 x 16 default grid /////
...
///// Makes a new grid after default grid is removed & user inputs rows /////
...
function resetNew() {
    ...
    ///// prompt user for how many rows in new grid /////
    ...
    /////  Reset the container to its original style /////
